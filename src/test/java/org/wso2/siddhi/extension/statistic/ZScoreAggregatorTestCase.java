...
public class ZScoreAggregatorTestCase {

    private static final Logger log = Logger.getLogger(ZScoreAggregatorTestCase.class);

    @Test
    public void timeWindowBatchTest1() throws InterruptedException {

        System.out.println("\nZ score TestCase 1 (Double)");
        ...
        String query = "" +
                "@info(name = 'query1') " +
                "from inputStream " +
                "select time, statistic:zScore(val) as sd " +
